...
class TorrentBase(DeclarativeHelperBase):
    ...
    def info_dict_path(self):
        ...
        base_dir = app.config.get('INFO_DICTS_DIR') or os.path.join(app.config['BASE_DIR'], 'info_dicts')
        return os.path.join(base_dir, info_hash[0:2], info_hash[2:4], info_hash)
